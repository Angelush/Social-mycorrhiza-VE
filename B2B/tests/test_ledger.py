...
PARAMS = {"neg_line_bp": 100, "pos_line_bp": 1000, "velocity_window_s": 86400,
          "velocity_max_cents": 5_000_000, "paused": False}
...
def fresh_cell(ts=1000):
    ...
    events = [ev]
    for mid in "ABCD":
        state, ev = led.add_member(state, {"id": mid, "turnover_eur_cents": 100_000_000}, "ana", ts)
        events.append(ev)
    return state, events
...
class TestGates:
    ...
    def test_add_member_bad_ratified_by(self):
        state, _ = fresh_cell()
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": 100_000_000}, "", 1010)
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": 100_000_000}, 123, 1010)
...
class TestRejections:
    ...
    def test_member_id_duplicate(self):
        state, _ = fresh_cell()
        assert_rejects(state, led.add_member, {"id": "A", "turnover_eur_cents": 100_000_000}, "ana", 1010)

    def test_turnover_bool(self):
        state, _ = fresh_cell()
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": True}, "ana", 1010)

    def test_credit_min_positive(self):
        state, _ = fresh_cell()
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": 100_000_000, "credit_min_cents": 5}, "ana", 1010)

    def test_credit_max_negative(self):
        state, _ = fresh_cell()
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": 100_000_000, "credit_max_cents": -5}, "ana", 1010)
    ...
    def test_paused_blocks_add(self):
        state, _ = fresh_cell()
        state, _ = led.pause_cell(state, "ana", 1010)
        assert_rejects(state, led.add_member, {"id": "E", "turnover_eur_cents": 100_000_000}, "ana", 1020)
    ...
    def test_velocity_window(self):
        ...
        for mid in "ABCD":
            state, _ = led.add_member(state, {"id": mid, "turnover_eur_cents": 1_000_000_000, "credit_min_cents": -10_000_000, "credit_max_cents": 10_000_000}, "ana", 1000)
    ...
    def test_projection_creditor_max(self):
        state, _ = fresh_cell()
        state, _ = led.add_member(state, {"id": "E", "turnover_eur_cents": 100_000_000, "credit_max_cents": 1000}, "ana", 1000)
    ...
    def test_projection_debtor_min(self):
        state, _ = fresh_cell()
        state, _ = led.add_member(state, {"id": "F", "turnover_eur_cents": 100_000_000, "credit_min_cents": -1000}, "ana", 1000)
