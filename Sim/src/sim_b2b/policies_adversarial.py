...
class SybilHopper(RulePolicy):
    def __init__(self, member_id: str, max_attempts: int = 5, fake_turnover_eur_cents: int = 1_000_000_000):
        self._member_id = member_id
        self._max_attempts = max_attempts
        self._fake_turnover = fake_turnover_eur_cents
        self._attempts = 0
    ...
    def act(self, view: FirmState, rng: Random) -> Proposal | None:
        ...
        return RegisterMember(
            ...
            turnover_eur_cents=self._fake_turnover,
