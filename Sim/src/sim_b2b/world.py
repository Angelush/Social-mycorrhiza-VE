    ...
    def observe(self, actor_id: str) -> object:
        if actor_id in {
            ...
            return CellView(
                ...
                statements={
                    fid: self.sut_adapter.member_statement(fid) for fid in self.neighbors
                },
                metrics=self.sut_adapter.cell_metrics(),
                tick=self.tick,
            )
        return FirmState(
            **self.sut_adapter.member_statement(actor_id),
                ...
                return self.sut_adapter.add_member(
                    {
                        ...
                        "turnover_eur_cents": proposal.turnover_eur_cents,
                    },
