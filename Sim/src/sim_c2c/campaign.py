...
Cooperative + adversarial population across a communal_gift cell and a market_price cell, driven by
...
def default_config(seed: int = 7, n_actors: int = 12, T: int = 30) -> RoundConfig:
    return RoundConfig(
        ...
        cells={GIFT_CELL: "communal_gift", MARKET_CELL: "market_price"},
